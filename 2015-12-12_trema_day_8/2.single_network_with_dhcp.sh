...
vnctl interfaces add --uuid if-dhcp --mode simulated --owner-datapath-uuid dp-test1 --mac-address 02:00:00:00:01:11 --network-uuid nw-test1 --ipv4-address 10.100.0.100
